...
require_once __DIR__ . '/../vendor/magento/community-edition/app/functions.php';

//stub objects
require __DIR__ . '/Stubs/InvoiceExtensionInterface.php';
require __DIR__ . '/Stubs/OrderAddressExtensionInterface.php';
require __DIR__ . '/Stubs/OrderPaymentExtensionInterface.php';
