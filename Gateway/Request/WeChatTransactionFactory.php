...
/**
 * Class WeChatTransactionFactory
 * @package Wirecard\ElasticEngine\Gateway\Request
 */
class WeChatTransactionFactory extends TransactionFactory
{
    ...
    /**
     * WeChatQrPayTransactionFactory constructor.
    ...
    public function create($commandSubject)
    {
        ...
        $subMerchantInfo->setMerchantId($this->methodConfig->getValue('sub_merchant_id'));
        if ($this->methodConfig->getValue('sub_merchant_name')) {
            $subMerchantInfo->setMerchantName($this->methodConfig->getValue('sub_merchant_name'));
        }
        $this->transaction->setSubMerchantInfo($subMerchantInfo);
